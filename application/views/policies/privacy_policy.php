...
<p>At <?= $site_name; ?>, accessible from <?= $full_url; ?>, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by <?= $site_name; ?> and how we use it.</p>
...
<P>You may consult this list to find the Privacy Policy for each of the advertising partners of <?= $site_name; ?>.</p>
